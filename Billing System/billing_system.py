...
class Bill_App:
    def __init__(self, master):
        ...
        bg_color = "#33FF95"
        title = Label(self.master, text="Billing Software", font=('times new roman', 30, 'bold'), pady=2, bd=12,
                      bg="#33FF95", fg="Black", relief=GROOVE)
        title.pack(fill=X)
        # ================variable section======================
        ...
        F1 = LabelFrame(self.master, text="Customer Details", font=('times new roman', 15, 'bold'), bd=10, fg="Black",
                        bg="#33FF95")
        ...
        cphn_lbl = Label(F1, text="Customer Phone:", bg="#33FF95", font=('times new roman', 15, 'bold'))
        ...
        c_bill_lbl = Label(F1, text="Bill Number:", bg="#33FF95", font=('times new roman', 15, 'bold'))
        ...
        # ===================Medical====================================
        F2 = LabelFrame(self.master, text="Medical Purpose", font=('times new roman', 15, 'bold'), bd=10, fg="Black",
                        bg="#33FF95")
        F2.place(x=5, y=180, width=325, height=380)

        sanitizer_lbl = Label(F2, text="Sanitizer", font=('times new roman', 16, 'bold'), bg="#33FF95", fg="black")
        ...
        mask_lbl = Label(F2, text="Mask", font=('times new roman', 16, 'bold'), bg="#33FF95", fg="black")
        ...
        hand_gloves_lbl = Label(F2, text="Hand Gloves", font=('times new roman', 16, 'bold'), bg="#33FF95", fg="black")
        ...
        syrup_lbl = Label(F2, text="Syrup", font=('times new roman', 16, 'bold'), bg="#33FF95", fg="black")
        ...
        cream_lbl = Label(F2, text="Cream", font=('times new roman', 16, 'bold'), bg="#33FF95", fg="black")
        ...
        thermal_gun_lbl = Label(F2, text="Thermal Gun", font=('times new roman', 16, 'bold'), bg="#33FF95", fg="black")
        ...
        # ==========GroceryItems=========================
        F3 = LabelFrame(self.master, text="Grocery Items", font=('times new roman', 15, 'bold'), bd=10, fg="Black",
                        bg="#33FF95")
        F3.place(x=340, y=180, width=325, height=380)

        rice_lbl = Label(F3, text="Rice", font=('times new roman', 16, 'bold'), bg="#33FF95", fg="black")
        ...
        food_oil_lbl = Label(F3, text="Food Oil", font=('times new roman', 16, 'bold'), bg="#33FF95", fg="black")
        ...
        wheat_lbl = Label(F3, text="Wheat", font=('times new roman', 16, 'bold'), bg="#33FF95", fg="black")
        ...
        spices_lbl = Label(F3, text="Spices", font=('times new roman', 16, 'bold'), bg="#33FF95", fg="black")
        ...
        flour_lbl = Label(F3, text="Flour", font=('times new roman', 16, 'bold'), bg="#33FF95", fg="black")
        ...
        maggi_lbl = Label(F3, text="Maggi", font=('times new roman', 16, 'bold'), bg="#33FF95", fg="black")
        ...
        # ===========ColdDrinks================================
        F4 = LabelFrame(self.master, text="Cold Drinks", font=('times new roman', 15, 'bold'), bd=10, fg="Black",
                        bg="#33FF95")
        F4.place(x=670, y=180, width=325, height=380)

        sprite_lbl = Label(F4, text="Sprite", font=('times new roman', 16, 'bold'), bg="#33FF95", fg="black")
        ...
        mineral_lbl = Label(F4, text="Mineral Water", font=('times new roman', 16, 'bold'), bg="#33FF95", fg="black")
        ...
        juice_lbl = Label(F4, text="Juice", font=('times new roman', 16, 'bold'), bg="#33FF95", fg="black")
        ...
        coke_lbl = Label(F4, text="Coke", font=('times new roman', 16, 'bold'), bg="#33FF95", fg="black")
        ...
        lassi_lbl = Label(F4, text="Lassi", font=('times new roman', 16, 'bold'), bg="#33FF95", fg="black")
        ...
        mountain_duo_lbl = Label(F4, text="Mountain Duo", font=('times new roman', 16, 'bold'), bg="#33FF95",
                                 fg="black")
        ...
        # =================Billing Area======================
        F5 = Frame(self.master, bd=10, relief=GROOVE)
        ...
        # =======================ButtonFrame=============
        F6 = LabelFrame(self.master, text="Bill Area", font=('times new roman', 14, 'bold'), bd=10, fg="Black",
                        bg="#33FF95")
        F6.place(x=0, y=560, relwidth=1, height=140)

        m1_lbl = Label(F6, text="Total Medical Price", font=('times new roman', 14, 'bold'), bg="#33FF95", fg="black")
        ...
        m2_lbl = Label(F6, text="Total Grocery Price", font=('times new roman', 14, 'bold'), bg="#33FF95", fg="black")
        ...
        m3_lbl = Label(F6, text="Total Cold Drinks Price", font=('times new roman', 14, 'bold'), bg="#33FF95",
                       fg="black")
        ...
        m4_lbl = Label(F6, text="Medical Tax", font=('times new roman', 14, 'bold'), bg="#33FF95", fg="black")
        ...
        m5_lbl = Label(F6, text="Grocery Tax", font=('times new roman', 14, 'bold'), bg="#33FF95", fg="black")
        ...
        m6_lbl = Label(F6, text="Cold Drinks Tax", font=('times new roman', 14, 'bold'), bg="#33FF95", fg="black")
